...
<form action="loginServlet" method="post">
    ...
    <span>验证码：</span><input type="text" name="code" placeholder="请输入验证码" autocomplete="off" style="width: 100px"><img src="CheckServ"><br><br>
    <input type="checkbox" name="accept">2天内自动登录<br>
